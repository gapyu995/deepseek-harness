...
/**
 * No runtime invariant: a single shell.overlay pet registration whose
 * disposal is proven by the browser-plugin HMR-safety spec — the plugin owns
 * no store (position and hide/show are component-local), emits no cordis
