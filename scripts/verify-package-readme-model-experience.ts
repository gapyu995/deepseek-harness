...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-pet': { kind: 'none', reason: 'Browser-side decorative overlay; the draggable mascot reads no session state and registers nothing model-facing.' },
  ...
  'packages/skill/skill-pdf-to-word': { kind: 'indirect', reason: 'The bundled provider delegates model rendering to dsh-tool-skill.' },
